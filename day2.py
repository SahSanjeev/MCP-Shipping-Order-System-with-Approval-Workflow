"""
Shipping Workflow Demo

This script demonstrates a shipping workflow with approval handling for large orders.
"""
...
async def generate_image():
    ...
    return await runner.run_debug("Provide a sample tiny image", verbose=True)

# Run the async function
response = asyncio.run(generate_image())
...
async def main():
    # Example 1: Small order (auto-approved)
    print("\n=== EXAMPLE 1: Small Order (Auto-Approved) ===")
    await run_shipping_workflow("Ship 3 containers to Berlin")
    
    # Example 2: Large order (requires approval)
    print("\n=== EXAMPLE 2: Large Order (With Approval) ===")
    await run_shipping_workflow("Ship 10 containers to Rotterdam")
    
    # Example 3: Large order (rejected)
    print("\n=== EXAMPLE 3: Large Order (Rejected) ===")
    await run_shipping_workflow("Ship 8 containers to Paris", auto_approve=False)
